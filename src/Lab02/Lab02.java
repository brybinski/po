...
public class Lab02 {
    ...
    public static int[][] transposeMatrix(int[][] matrix){
        ...
        for(int i =0; i < matrix[0].length; i++){
            ...
            if (matrix[0].length + 1 >= 0) System.arraycopy(tmp, 0, result[i], 0, matrix[0].length + 1);
        }
        return result;
    }
    ...
    static public void main(String[] args) {
        int[][] matrix1 = generateIntMatrix(2, 5, -10, 10);
        printMatrix(matrix1);

        int[][] matrix2 = generateIntMatrix(5, 2, -10, 10);
        printMatrix(matrix2);
        ...
        System.out.println(dotProduct(a[0], transposeMatrix(b)[0]));
